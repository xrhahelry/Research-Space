...
\textcite{wang2021graphlearningbasedrecommender}.

Many researchers have explored graph-based recommendation methods. For instance,
\textcite{10.1145/3292500.3330673} employed a path-based approach for intent
...
\textcite{song2022ekarexplainablemethodknowledge} also proposed a path based
reinforcement learning method by formulating recommendation as a sequential
decision process. While \textcite{10.1145/3109859.3109889} utilized an embedding-based
method. Similarly, \textcite{10.1145/2939672.2939673} also used an embedding-based
...
\textcite{10.1145/2939672.2939673} used the TransR which was proposed by
\textcite{10.3233/JIFS-202177} which is a modification to the original TransE proposed
by \textcite{NIPS2013_1cecc7a7}.  TransE and TransR are both methods to represent
...
\textcite{liu2025academicliteraturerecommendationlargescale} proposed a hybrid
...
Another study, \textcite{church2024academicarticlerecommendationusing} explored the
...
\textcite{cohan-etal-2020-specter}, a BERT-based model
for encoding abstracts, and ProNE \textcite{zhang2019prone}, a spectral clustering-based method applied to
...
\textcite{edge2025localglobalgraphrag}.

\textcite{edge2025localglobalgraphrag} proposed GraphRAG, a graph-based approach
...
\textcite{beltagy2019scibertpretrainedlanguagemodel} and KeyBERT \textcite{10295108}
...
\textcite{beltagy2019scibertpretrainedlanguagemodel} and TransR
\textcite{10.3233/JIFS-202177} embeddings will be combined (e.g., concatenated or
